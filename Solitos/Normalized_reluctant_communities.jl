...
parser = ArgParseSettings(description = "Find communities using Normalized reluctant algorithm.")
...
debug("Your results will be saved as: Normalized_reluctant_communities_$(a[k]) \n")
